  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-950/80 backdrop-blur-2xl p-4">
      <div className="w-full max-w-md flex flex-col items-center gap-6">
        <Card className="w-full border-white/10 bg-slate-900 shadow-2xl overflow-hidden rounded-[2.5rem]">
        ...
        {/* Setup Dev Credit */}
        <div className="text-center select-none animate-in fade-in slide-in-from-bottom-2 duration-1000 delay-300">
          <p className="text-[10px] font-bold uppercase tracking-[0.4em] flex items-center justify-center gap-2">
            <span className="text-slate-500">Made with ❤️ by</span>
            <a 
